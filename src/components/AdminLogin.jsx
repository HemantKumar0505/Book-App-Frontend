        ...
        <div className='w-full max-w-sm mx-auto bg-yellow-200 shadow-md p-8 pt-6 pb-8 mb-4  rounded-lg'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    ...
                    type='text' name='username' id='username' placeholder=' username' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus-shadow bg-blue-100 '/>
                </div>
                <div className='mb-4'>
